...
With all these variables, the proposed price calculation is the one of Eq. \ref{MBPrice1}, with DL the arriving time of the task. This price calculation's goal is to balance the energy consumption among the nodes and to achieve a quicker processing time to more urgent tasks.
