...
%----------------------------------------------------------------------------------------
The main aim of this thesis is to implement and compare a distributed task scheduler proposed in \cite{Araguz15} with some distributed scheduling algorithms % OJO %.
...
The distributed nature of our system suppose an added complexity to our problem: we want to solve an NP-hard problem 
