...
task(1).
task_priority(1,1).
task_timing(1, period(0,0,15,0), duration(1), init_delay(0,0,0,0), infinity, 0.000000).
...
task(2).
task_priority(2,2).
task_timing(2, period(0,0,15,0), duration(1), init_delay(0,0,0,0), infinity, 0.000000).
...
task(3).
task_priority(3,2).
task_timing(3, period(0,0,15,0), duration(1), init_delay(0,0,0,0), infinity, 0.000000).
